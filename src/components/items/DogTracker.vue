<template>
  <v-card v-focus-section:userinfo class="mx-auto mb-4 box-dog-information" max-width="340px" tile>
    <v-row v-focus>
      <v-col class="avatar" cols="3" md="3" sm="3">
        <v-avatar color="" size="100" tile>
          <v-img :src="`./images/pet.svg`"></v-img>
        </v-avatar>
      </v-col>
      <v-col class="user-info" cols="9" md="9" sm="9">
        ...
        <div v-focus class="radius rounded pa-2 text-center logout-button text-no-wrap">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        items: [
          {name: 'Jackie', text: 'Lorem Ipsum is simply dummy text of the printing '}
        ],
        user: null
      }
    },
